...
// There is no device math function for long double type on MACA platform, so add them.
#if defined(EIGEN_MACA_ARCH)
#include "arch/MACA/mxcc/macac_math.h"
#endif
...
// HIP/MACA and CUDA do not support long double.
#ifndef EIGEN_GPU_COMPILE_PHASE
template<>
EIGEN_DEVICE_FUNC
