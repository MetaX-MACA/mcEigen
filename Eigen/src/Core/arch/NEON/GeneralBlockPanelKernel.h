...
template<>
struct gebp_traits <Eigen::half,Eigen::half,false,false,Architecture::NEON>
 : gebp_traits<Eigen::half,Eigen::half,false,false,Architecture::Generic>
{
  typedef Eigen::half RhsPacket;
