...
template<>
struct PacketType<Eigen::half, GpuDevice> {
...
template <>
  struct PacketType<Eigen::half, SyclDevice> {
...
template<> struct PacketType<Eigen::half, const SyclDevice>: PacketType<Eigen::half, SyclDevice>{};
template<> struct PacketType<const Eigen::half, const SyclDevice>: PacketType<Eigen::half, SyclDevice>{};
#endif
#endif
