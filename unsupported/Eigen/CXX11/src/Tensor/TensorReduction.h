...
#if defined(__clang__) && (defined(__CUDA__) || defined(__HIP__) || defined(__MACA__))
...
template <>
EIGEN_DEVICE_FUNC inline Index LeafSize<Eigen::half>() { return 200; }
template <>
...
__global__ EIGEN_HIP_LAUNCH_BOUNDS_1024 void ReductionInitFullReduxKernelHalfFloat(R, const S, I_, internal::packet_traits<Eigen::half>::type*);
template <int B, int N, typename S, typename R, typename I_>
__global__ EIGEN_HIP_LAUNCH_BOUNDS_1024 void FullReductionKernelHalfFloat(R, const S, I_, Eigen::half*, internal::packet_traits<Eigen::half>::type*);
template <int NPT, typename S, typename R, typename I_>
__global__ EIGEN_HIP_LAUNCH_BOUNDS_1024 void InnerReductionKernelHalfFloat(R, const S, I_, I_, Eigen::half*);
...
static constexpr bool RunningOnGPU = false;
  ...
  template <int B, int N, typename S, typename R, typename I_> KERNEL_FRIEND void internal::FullReductionKernelHalfFloat(R, const S, I_, Eigen::half*, internal::packet_traits<Eigen::half>::type*);
  template <int NPT, typename S, typename R, typename I_> KERNEL_FRIEND void internal::InnerReductionKernelHalfFloat(R, const S, I_, I_, Eigen::half*);
#endif
