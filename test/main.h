...
// compiler error.
#if !defined(__HIPCC__) && !defined(__MACACC__) && !defined(EIGEN_USE_SYCL) && !defined(EIGEN_POCKETFFT_DEFAULT)
  //
...
#define EIGEN_DEFAULT_IO_FORMAT IOFormat(4, 0, "  ", "\n", "", "", "", "")
...
#if (defined(_CPPUNWIND) || defined(__EXCEPTIONS)) && !defined(__CUDA_ARCH__) && !defined(__HIP_DEVICE_COMPILE__) && !defined(__MACA_ARCH__) && !defined(__SYCL_DEVICE_ONLY__)
  ...
  #elif !defined(__CUDACC__) && !defined(__HIPCC__) && !defined(__MACACC__) && !defined(__SYCL_DEVICE_ONLY__) // EIGEN_DEBUG_ASSERTS
    #define eigen_assert(a) \
      if( (!(a)) && (!no_more_assert) )       \
      {                                       \
        Eigen::no_more_assert = true;         \
  ...
  #if !defined(__CUDACC__) && !defined(__HIPCC__) && !defined(__MACACC__) && !defined(SYCL_DEVICE_ONLY)
...
EIGEN_TEST_SCALAR_TEST_OVERLOAD(Eigen::half)
